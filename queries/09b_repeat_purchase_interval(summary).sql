...
--    summary metrics.
-- 2. Metrics are calculated both including
--    and excluding same-day repeat purchases.
-- 3. Same-day repeats may represent split carts,
--    checkout retries, or multiple purchases
--    within a single session.
-- Sanity Checks:
-- 1. days_to_next_order >= 0
-- 2. median_days_to_next_order <=
...
select
    'including_same_day'                           as methodology
  , avg_days_to_next_order
  , median_days_to_next_order
  , p90_days_to_next_order
  , customers_with_repeat_order
from repeat_purchase_summary_all

union all

select
    'excluding_same_day'                           as methodology
  , avg_days_to_next_order
  , median_days_to_next_order
  , p90_days_to_next_order
  , customers_with_repeat_order
from repeat_purchase_summary_true_return;